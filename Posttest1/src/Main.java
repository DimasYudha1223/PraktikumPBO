...
//    }
    ...
    public static void lihatKdr() {
        ...
        for (int i = 0; i < kendaraan.size(); i++) {
            ...
            System.out.println("Jenis Kendaraan: " + kendaraan.get(i).kategori);
            System.out.println("KT Kendaraan: " + kendaraan.get(i).KT);
            System.out.println("Waktu Masuk Kendaraan: " + kendaraan.get(i).waktu_masuk);
            System.out.println("Waktu Keluar Kendaraan: " + kendaraan.get(i).waktu_keluar);
            System.out.print("\n");
        }
    }
    ...
    public static void ubahKdr() throws IOException{
        ...
        kendaraan.get(index-1).kategori = setKTG;
        kendaraan.get(index-1).KT = setKTKdr;
        kendaraan.get(index-1).waktu_masuk = setWKTMSK;
        kendaraan.get(index-1).waktu_keluar = setWKTKLR;
